        ...
        <div className='max-w-7xl mx-auto'>
          ...
          <div className='bg-slate-800 border border-slate-700 rounded-2xl overflow-hidden'>
            ...
            <img
              ...
              className="w-full h-40 sm:h-48 md:h-56 lg:h-72 object-contain"
            />
            <div className='p-6 sm:p-8 md:p-10'>
              <div className='flex flex-col sm:flex-row items-start sm:items-center mb-4 gap-3'>
                ...
                <h3 className='text-xl sm:text-3xl font-bold text-white'>Predict the <span className='text-gradient'>2026</span> Season ? </h3>
              </div>
          ...
          >
            ...
            >
              <div className='relative bg-black w-full h-[500px]'>
                ...
                />
                {hoveredVideo !== 1 && (
                  <div className='absolute inset-0 bg-cover bg-center' style={{ backgroundImage: "url('/images/v.jpeg')" }}>
                  </div>
                )}
                <button
            ...
            >
              <div className='relative bg-black w-full h-[500px]'>
                ...
                />
                {hoveredVideo !== 0 && (
                  <div className='absolute inset-0 bg-cover bg-center' style={{ backgroundImage: "url('/images/n.jpeg')" }}>
                  </div>
                )}
                <button
            ...
            >
              <div className='relative bg-black w-full h-[500px]'>
                ...
                />
                {hoveredVideo !== 2 && (
                  <div className='absolute inset-0 bg-cover bg-center' style={{ backgroundImage: "url('/images/p.jpeg')" }}>
                  </div>
                )}
                <button
            ...
            >
              <div className='relative bg-black w-full h-[500px]'>
                ...
                />
                {hoveredVideo !== 3 && (
                  <div className='absolute inset-0 bg-cover bg-center' style={{ backgroundImage: "url('/images/m.jpeg')" }}>
                  </div>
                )}
                <button
