...
const Footer = () => {
            ...
            <div className='flex sm:flex-row flex-col sm:gap-0 gap-4 justify-between items-center'>
              ...
              <div className='flex items-center sm:gap-10 gap-6'>
                <a
                  ...
                  href='https://www.facebook.com/profile.php?id=61564116434948'
                >
                  <svg
                    role='img'
                    viewBox='0 0 24 24'
                ...
                <a
                  target='_blank'
                  rel='noopener noreferrer'
                  href='https://www.linkedin.com/in/auft-football?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'
                >
                  <svg
                    role='img'
                    viewBox='0 0 24 24'
                ...
                <a
                  target='_blank'
                  rel='noopener noreferrer'
                  href='https://www.instagram.com/_auft_/?igsh=cmlydmR2MTZubDFy#'
                >
                  <svg
                    role='img'
                    viewBox='0 0 24 24'
  ...
  target="_blank"
  rel="noopener noreferrer"
  href="https://www.youtube.com/@AUFTtv/streams"
>
  <svg
    role="img"
    viewBox="0 0 24 24"
  ...
  >
    <title>YouTube</title>
    <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.121 2.136c1.873.505 9.377.505 9.377.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
  </svg>
</a>
